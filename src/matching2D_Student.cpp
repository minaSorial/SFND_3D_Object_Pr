                      ...
                      std::vector<cv::DMatch> &matches, std::string descriptorType, std::string matcherType, std::string selectorType)
{
    ...
    if (matcherType.compare("MAT_BF") == 0 && descriptorType.compare("DES_BINARY")==0 )
    {
        int normType = cv::NORM_HAMMING;
        matcher = cv::BFMatcher::create(normType, crossCheck);
    }
    else if(matcherType.compare("MAT_BF") == 0 && descriptorType.compare("DES_HOG")==0 ) {
    ...
    else if (matcherType.compare("MAT_FLANN") == 0)
    {
        ...
        { // OpenCV bug workaround : convert binary descriptors to floating point due to a bug in current OpenCV implementation
           // cout << "I convertedthe descriptot" << endl;
...
// Use one of several types of state-of-art descriptors to uniquely identify keypoints BRISK, BRIEF, ORB, FREAK, AKAZE, SIFT
